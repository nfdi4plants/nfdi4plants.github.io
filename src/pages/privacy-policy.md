...
- Information about the browser type, version used and operating system of the accessing computer (if transmitted by the requesting web browser)
...
| --------------------------- | --------- | ---------------------------------- | -------------------------------- |
| uni-freiburg.de             | serverid  | Load balancer assignment           | Until the end of browser session |
| videoportal.uni-freiburg.de | framework | Session-ID, Timestamp, Videoplayer | 7 Days                           |

_Table 1: Overview of technically required cookies_
...
_Table 2: Cookies for managing consent_
...
- The device type used, the operating system, the browser type, the browser version, the screen resolution and the language setting
...
- [Facebook](https://www.uni-freiburg.de/datenschutz-socialmedia/facebook)
- [X (formerly Twitter](https://www.uni-freiburg.de/datenschutz-socialmedia/twitter))
- [Instagram](https://www.uni-freiburg.de/datenschutz-socialmedia/instagram)
- [Youtube](https://www.uni-freiburg.de/datenschutz-socialmedia/youtube)
- [Xing](https://www.uni-freiburg.de/datenschutz-socialmedia/xing)
- [LinkedIn](https://www.uni-freiburg.de/datenschutz-socialmedia/linkedin)
- [Bluesky](https://uni-freiburg.de/social-media/#bluesky)
...
- if you contest the accuracy of the personal data concerning you, for a period that enables the University of Freiburg to verify the accuracy of the personal data,
- the processing is unlawful and you refuse to delete the personal data and instead request that the use of the personal data be restricted,
- the University of Freiburg no longer needs the personal data for the purposes of processing, but you require it to assert, exercise or defend legal claims, or
- if you have objected to the processing in accordance with Art. 21 Para. 1 GDPR and it has not yet been determined whether the legitimate reasons of the University of Freiburg outweigh your reasons.
...
- The deletion of the personal data concerning you is necessary to fulfill a legal obligation under Union law or the law of the Member States to which the University of Freiburg is subject.
...
- to fulfil a legal obligation which requires processing under Union or Member State law to which the University of Freiburg is subject, or to carry out a task carried out in the public interest or in the exercise of official authority vested in the University of Freiburg,
- for reasons of public interest in the area of ​​public health pursuant to Art. 9 (2)(h) and (i) and Art. 9 (3) GDPR,
- for archiving purposes in the public interest, scientific or historical research purposes or for statistical purposes pursuant to Art. 89 (1) GDPR, insofar as the right referred to in Section 4.1 is likely to make the realisation of the objectives of this processing impossible or seriously compromises it, or
...
Epicur
![Logo of Epicur](https://uni-freiburg.de/en/wp-content/uploads/sites/61/Epicur-Header-inline-1568x1045-1-e1724228907195.jpg)

Eucor
![Logo of Eucor](https://uni-freiburg.de/en/wp-content/uploads/sites/61/eucor.png)

German U15
![Logo of German U15](https://uni-freiburg.de/en/wp-content/uploads/sites/61/u15.png)

Charta der Vielfalt
![Logo of Charta der Vielfalt](https://uni-freiburg.de/en/wp-content/uploads/sites/61/charta-1.png)

LeRu
![Logo of LeRu21](https://uni-freiburg.de/en/wp-content/uploads/sites/61/leru.png)

Universität Freiburg
![Logo of Total Equality](https://uni-freiburg.de/en/wp-content/uploads/sites/61/diversity.png)
