          ...
          <div class="navbar-start is-justify-content-center is-flex-grow-1">
            ...
            <div class="navbar-item has-dropdown is-hoverable">
                ...
                <div class="navbar-dropdown is-active smooth-hover">
                  ...
                  <a class=${this.url == "${mainPageBaseUrl}content/docs/Feedback.html" ? "navbar-item is-active smooth-hover" : "navbar-item"} href="${mainPageBaseUrl}content/docs/Feedback.html">
                    Feedback
                  </a>
                </div>
              </div>
